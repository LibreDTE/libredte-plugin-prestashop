...
class Utility_Rut
{
     ...
     * @param rut RUT que se quiere transformar
     * @param quitarDV Si es true el dígito verificador se quita, sino se mantiene
    ...
    {
        if (is_array($rut)) return self::normalizar_array($rut, $quitarDV);
     ...
     * @param rut RUT en formato número y sin dígito verificador
     * @return RUT formateado
     * @author Esteban De La Fuente Rubio, DeLaF (esteban[at]delaf.cl)
     * @version 2014-11-01
     */
